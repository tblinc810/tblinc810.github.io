...
export function getFullUrl(path) {
  ...
  let ip = '172.16.50.7';
  if (server === 'DHAKA-FLIX-8') ip = '172.16.50.8';
  if (server === 'DHAKA-FLIX-9') ip = '172.16.50.9';
  if (server === 'DHAKA-FLIX-12') ip = '172.16.50.12';
  if (server === 'DHAKA-FLIX-14') ip = '172.16.50.14';
